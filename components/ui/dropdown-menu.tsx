...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent
        ref={ref}
        className={cn(
            "z-50 min-w-32 overflow-hidden rounded-md border border-slate-200 bg-white p-1 text-slate-900 shadow-md shadow-black/10",
            "dark:border-slate-700/60 dark:bg-slate-900 dark:text-slate-100 dark:shadow-none",
            className
        )}
        {...props}
    />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
            ...
            className={cn(
                "z-50 min-w-48 overflow-hidden rounded-md border border-slate-200 bg-white p-1 text-slate-900 shadow-md shadow-black/10",
                "dark:border-slate-700/60 dark:bg-slate-900 dark:text-slate-100 dark:shadow-none",
                className
            )}
            {...props}
...
>(({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ...
        className={cn(
            ...
            "dark:focus:bg-slate-800/70 dark:focus:text-slate-100",
            "data-[inset=true]:pl-8",
            className
        )}
        {...props}
...
>(({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.Separator
        ref={ref}
        className={cn("my-1 h-px bg-slate-200 dark:bg-slate-700/60", className)}
        {...props}
    />
))
