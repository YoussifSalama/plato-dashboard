...
const JobSuccessScreen = ({
	...
	const actions = [
		...
		},
		{
			...
			href: jobId ? `/job/watch?id=${jobId}&accountId=${accountId}` : "/jobs",
		},
	];
		...
		<div className="mx-auto max-w-2xl space-y-6 py-8">
			...
			<div className="rounded-xl bg-[#005ca9] p-5 text-white">
				...
				<p className="mt-2 text-sm cursor-pointer text-blue-100">
					Share your job posting on LinkedIn, Twitter, and other social
					platforms to reach more qualified candidates!
				</p>
				<button
					type="button"
