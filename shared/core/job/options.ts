...
export const seniorityLevelOptions = [
    { label: "Internship", value: "internship" },
    { label: "Entry level", value: "entery_level" },
...
export const jobSoftSkillsOptions = [
    ...
    { label: "Strategic thinking", value: "strategic_thinking" },
    ...
    { label: "Cultural awareness", value: "cultural_awareness" },
    { label: "Decision making", value: "decision_making" },
    { label: "Collaboration", value: "collaboration" },
];

export const jobTechnicalSkillsOptions = [
